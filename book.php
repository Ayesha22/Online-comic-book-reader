...
Length-496 pages</p>
		...
		<a href="read1.php?id2=<?php echo $product['b_pdf'];?>" class="btn btn-primary pull-right">READ NOW</a>
		
		<!--<a href="read1.php" name="buy" class="btn btn-outline-secondary pull-right">DISCOVER</a>
<a class="btn btn-outline-secondary pull-right" name="buy"><?php //echo $product['b_pdf'];?>
