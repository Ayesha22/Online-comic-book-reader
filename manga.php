...
<div class="row">
<?php
$query= "SELECT `b_id`, `bname`, `bcategory`, `b_publisher`, `b_pdf`, `b_isbn`,`b_img` FROM `book` WHERE bcategory='manga'";
//echo$query;
	...
	while($product=mysqli_fetch_array($result)){
 	...
 	<form>
 		<div class="card">
 			...
 			<div class="card-body">
 				<img src="<?php echo $product['b_img']; ?>" alt="hulk" title="Manga" class="img-fluid">
